 ...
 ?>
    ...
    <div class="container">
      ...
      <form action="#" method="POST">
        ...
        <table align="center">
          <tr>
            <td><b><font size="4">Id Descuento:&nbsp;&nbsp;</font></b></td>
            <td><input class="form-control" type="text" name="id" ></td>
          </tr>
          <tr>
            <td><b><font size="4">Cantidad:&nbsp;&nbsp;</font></b></td>
            <td><input class="form-control" type="text" name="cant" ></td>
            <td><b><font size="4">&nbsp;%</font></b></td>
          </tr>
        </table>
        <br>
        <table align="center">
      ...
      require '../Model/DAODescuento.php';
      $dao = new DAODescuento();
      $dao->listar();
      ...
      if(isset($_REQUEST['add'])){
      	$dao->insertar(cargar());
        echo '<script language="javascript">location.href = "mantenimientoDescuentos.php";</script>';
      }
